...
<head>
      <meta charset="UTF-8" />
    <title>DLSL LMS | Book Borrowing Form</title>
       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Book Borrowing Form</h1>
                </div>
            </div>
    ...
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Student Number</label>

                    <div class="col-lg-5">
                        <input type="text" id="text1" placeholder="Type student number" class="form-control" />
                    </div>
                </div>
                    ...
                    <div id="dateRangePickerBlock" class="body collapse in">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-4">Books Borrowed</label>
                            
                                <div class="col-lg-5">
                                    <select data-placeholder="Select the books you want to borrow" class="form-control chzn-select" multiple="multiple" tabindex="6">
                                        <optgroup label="Fiction">
                                            <option>You Only Call When You're in Trouble: A Novel</option>
                                            <option>The Memory Library</option>
                                            <option>The Dead Take the A Train</option>
                                            <option>Never Lie</option>
                                            <option>The Edge</option>
                                            <option>The Road to Jerusalem</option>
                                            <option>Prime Deceptions: A Novel</option>
                                            <option>The Teacher</option>
                                            <option>The Swimmer: A Novel</option>
                                        </optgroup>
                                        <optgroup label="Light Novel">
                                            <option>That Time I Got Reincarnated as a Slime, Vol. 13</option>
                                            <option>Sasaki and Peeps, Vol. 5</option>
                                            <option>Mushoku Tensei: Jobless Reincarnation, Vol. 15</option>
                                        </optgroup>
                                        <optgroup label="Fantasy">
                                            ...
                                            <option>Mushoku Tensei: Jobless Reincarnation, Vol. 15</option>
                                            <option>The Dead Take the A Train</option>
                                            <option>A Court of Mist and Fury</option>
                                        </optgroup>
                                        <optgroup label="Action">
                                            <option>The Edge</option>
                                            <option>The Swimmer: A Novel</option>
                                            <option>Island 731</option>
                                            <option>SecondWorld</option>
                                        </optgroup>
                                        <optgroup label="Thriller">
                                            <option>Dark State</option>
                                            <option>The Guardians: A Novel</option>
                                            <option>Never Lie</option>
                                            <option>The Road to Jerusalem</option>
                                            <option>Matterhorn</option>
                                            <option>The Perfect Son</option>
                                            <option>The Teacher</option>
                                            <option>The Housemaid</option>
                                            <option>Island 731</option>
                                            <option>SecondWorld</option>
                                        </optgroup>
                                        <optgroup label="Suspense">
                                            <option>The Guardians: A Novel</option>
                                            <option>Day of Horror: Novel</option>
                                            <option>Matterhorn</option>
                                            <option>The Housemaid</option>
                                            <option>Island 731</option>
                                            <option>SecondWorld</option>
        ...
        <form action="index2.php" class="form-student">
